...
public class BSPTreeBuilder
{
    ...
    public void HandleTriangleBasedOnPosition(
        TrianglePosition position,
        Triangle toCheck,
        Triangle mainTriangle,
        Node node,
        List<Triangle> backTriangles,
        List<Triangle> frontTriangles,
    ...
    public List<Triangle> DivideTriangleEasy(Triangle toCheck, Triangle mainTriangle)
    {
        ...
        Point3D? intersectionPointPosition = GetPoinfOfIntersection(
            front.CurrentPosition,
            back.CurrentPosition,
            mainTriangle
        );
        Point3D? intersectionPointOriginalPosition = GetPoinfOfIntersection(
            front.OriginalPosition,
            back.OriginalPosition,
            mainTriangle
        );
        ...
        Point intersectionPoint = new Point(
            intersectionPointOriginalPosition,
    ...
    public static Point3D? GetPoinfOfIntersection(Point3D front, Point3D back, Triangle triangle)
    {
        ...
        double n = Vector.GetDotProduct(
            normal,
            Vector.GetVector(front, triangle.P1.CurrentPosition)
        );
    ...
    public static (Point front, Point back, Point plain) GetPreparedPointsForEasyDivide(
        Triangle toCheck,
        Triangle mainTriangle
    )
    {
    ...
    public List<Triangle> DivideTriangleHard(Triangle toCheck, Triangle mainTriangle)
    {
        ...
        Point3D? intersectionPoint1Position = GetPoinfOfIntersection(
            sideA1.CurrentPosition,
            sideB1.CurrentPosition,
            mainTriangle
        );
        Point3D? intersectionPoint1OriginalPosition = GetPoinfOfIntersection(
            sideA1.OriginalPosition,
            sideB1.OriginalPosition,
            mainTriangle
        );
        ...
        Point intersectionPoint1 = new Point(
            intersectionPoint1OriginalPosition,
            intersectionPoint1Position
        );

        Point3D? intersectionPoint2Position = GetPoinfOfIntersection(
            sideA2.CurrentPosition,
            sideB1.CurrentPosition,
            mainTriangle
        );
        Point3D? intersectionPoint2OriginalPosition = GetPoinfOfIntersection(
            sideA2.OriginalPosition,
            sideB1.OriginalPosition,
            mainTriangle
        );
        ...
        Point intersectionPoint2 = new Point(
            intersectionPoint2OriginalPosition,
            intersectionPoint2Position
        );
    ...
    public static (Point sideA1, Point sideA2, Point sideB1) GetPreparedPointsForHardDivide(
        Triangle toCheck,
        Triangle mainTriangle
    )
    {
        ...
        sideA1 = toCheck.P1;
        if (
            pointPosition1 < -Epsilon && pointPosition2 < -Epsilon
            || pointPosition1 > Epsilon && pointPosition2 > Epsilon
        )
        {
            sideA2 = toCheck.P2;
        ...
        else
        {
            ...
            if (
                pointPosition1 < -Epsilon && pointPosition3 < -Epsilon
                || pointPosition1 > Epsilon && pointPosition3 > Epsilon
            )
            {
                sideB1 = toCheck.P2;
