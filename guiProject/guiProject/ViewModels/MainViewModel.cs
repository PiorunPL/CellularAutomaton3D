...
public class MainViewModel : ReactiveObject
{
    ...
    public MainViewModel()
    {
        ...
        this.WhenAnyValue(x => x.CameraViewImage).Subscribe(_ => DrawImage());

        Observable
            .Interval(_displayTimeSpan)
            .Select(_ => Controller.CreatePhoto())
    ...
    private void SetUpHooks()
    {
        ...
        {
            KeyPressed((char)args.Data.RawCode);
        };
        _hook.KeyReleased += (_, args) =>
        {
            KeyReleased((char)args.Data.RawCode);
        };
        _hook.RunAsync();
    }
        ...
        switch (charCode)
        {
            case 'e':
                if (_inputController.ObservatorW == null)
                    _inputController.ObservatorW = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => GoForward())
                        .Subscribe();
                break;
            case 's':
                if (_inputController.ObservatorA == null)
                    _inputController.ObservatorA = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => GoLeft())
                        .Subscribe();
                break;
            case 'd':
                if (_inputController.ObservatorS == null)
                    _inputController.ObservatorS = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => GoBackward())
                        .Subscribe();
                break;
            case 'f':
                if (_inputController.ObservatorD == null)
                    _inputController.ObservatorD = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => GoRight())
                        .Subscribe();
                break;
            case 't':
                if (_inputController.ObservatorU == null)
                    _inputController.ObservatorU = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => GoUp())
                        .Subscribe();
                break;
            case 'g':
                if (_inputController.ObservatorI == null)
                    _inputController.ObservatorI = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => GoDown())
                        .Subscribe();
                break;
            case 'j':
                if (_inputController.ObservatorQ == null)
                    _inputController.ObservatorQ = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => TurnLeft())
                        .Subscribe();
                break;
            case 'l':
                if (_inputController.ObservatorE == null)
                    _inputController.ObservatorE = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => TurnRight())
                        .Subscribe();
                break;
            case 'k':
                if (_inputController.ObservatorJ == null)
                    _inputController.ObservatorJ = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => TurnDown())
                        .Subscribe();
                break;
            case 'i':
                if (_inputController.ObservatorK == null)
                    _inputController.ObservatorK = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => TurnUp())
                        .Subscribe();
                break;
            case 'u':
                if (_inputController.ObservatorH == null)
                    _inputController.ObservatorH = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => TurnCounterClockwise())
                        .Subscribe();
                break;
            case 'o':
                if (_inputController.ObservatorL == null)
                    _inputController.ObservatorL = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => TurnClockwise())
                        .Subscribe();
                break;
            case 'w':
                if (_inputController.ObservatorMinus == null)
                    _inputController.ObservatorMinus = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => ZoomOut())
                        .Subscribe();
                break;
            case 'r':
                if (_inputController.ObservatorEqual == null)
                    _inputController.ObservatorEqual = Observable
                        .Interval(_readKeyTimeSpan)
                        .Do(_ => ZoomIn())
                        .Subscribe();
                break;
